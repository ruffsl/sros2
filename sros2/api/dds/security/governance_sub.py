...
import sros2.api.dds.security.governance as supermod
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from sros2.api.dds.security.governance import *\n\n')
        sys.stdout.write('import sros2.api.dds.security.governance as model_\n\n')
